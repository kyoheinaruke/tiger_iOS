...
class SearchItemTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        //        if let storedMyItemList = userDefaults.object(forKey: "myItemList") as? Data {
        //            if let unarchiveTodoList = NSKeyedUnarchiver.unarchiveObject(with: storedMyItemList) as? [MyItemList] {
        //                itemDataArray.append(contentsOf: storedMyItemList)
        //
        //            }
        //        }
